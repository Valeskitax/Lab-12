...
//people.map (employeeFullName)

const getOnlyName = (employee) => ({ name: employee.name })
const getNameAndCity = (employee) => ({ name: employee.name , city: employee.city })
const peopleName = people.map(getNameAndCity)
